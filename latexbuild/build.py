...
class LatexBuild(object):
    ...
    def run_latex(self, cmd_wo_infile, path_outfile,
        ...
        :param ignore_aux: ignore the aux step
        '''
        ...
        if cmd_wo_infile[0] == 'latex2rtf' and len(cmd_wo_infile) == 1:
            # If converting to word, must explicitly create temp outfile
            cmd_wo_infile += ['-o', path_outfile_initial]
        try:
            ...
            while old_aux != new_aux:
                ...
                LOGGER.debug('\n'.join(stdout))
                if ignore_aux:
                    # Some 3rd-party processes don't rely on aux
                    break
